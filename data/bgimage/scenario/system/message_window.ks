;メッセージレイヤの定義
		...
		[position width=710 height=440 top=773 left=20 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=30 y=783 bold="bold" edge="" shadow=""]
		...
		[position layer="message1" width=710 height=440 top=773 left=20 ]
